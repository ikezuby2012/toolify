...
const envVarsSchema = joi_1.default.object()
    ...
    CLOUD_API_SECRET: joi_1.default.string().description("cloud api secret"),
    CLOUD_API_KEY: joi_1.default.string().description("cloud api key"),
    CLOUD_API_NAME: joi_1.default.string().description("cloud api name"),
